...
rails-api, is a way to greet someone in a very difficult way
...
<!-- https://github.com/EmiLoKiJu/rails-api -->

### Link to backend <a name="link-to-backend"></a>

The backend repository link: https://github.com/EmiLoKiJu/react-redux-frontend
...
```
cd my-folder
git clone https://github.com/EmiLoKiJu/rails-api.git
```
...
Make sure to follow the steps in the frontend repository to run the full project.

### Run tests

Not implemented tests

<p align="right">(<a href="#rails-api">back to top</a>)</p>
